...
@RegisteredInstanceCommand('2.19.0', 1783327869173)
export class AddManifestFileIdToApplicationRegistrationFastInstanceCommand implements FastInstanceCommand {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "core"."applicationRegistration" ADD CONSTRAINT "FK_013bed14ac092b0e62c6aabb485" FOREIGN KEY ("manifestFileId") REFERENCES "core"."instanceFile"("id") ON DELETE SET NULL ON UPDATE NO ACTION');
  }
